...
3. **Откалибруйте** — нейтральная стойка на ровном, кнопка «Калибровка датчика» (раздел [2.2](#22-экран-датчик--статус-заряд-калибровка)).
...
- **Калибровка датчика** — внизу экрана. Выполняйте перед катанием, стоя в нейтральной стойке на ровной поверхности.
